...
### Univariate approach using lme() maximum likelihood
This method fits a linear mixed-effects model.
```{r}
lme.model <- lme(MEPHR ~ TestNumber, 
                 meth = "ML", 
                 random = ~1|Subject/TestNumber, data=obs)
summary(lme.model)
```
...
----
## Boxplots
Duplicate TestNumber and set the factor values.  This is simply to make the labels on the box plots fit the requirements of the mad scientist.
```{r}
