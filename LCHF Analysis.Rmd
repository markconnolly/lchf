...
fuel <- 
  subset(vo2data, 
         subj==subject & 
        testnumber == testnumber)[,c("%Fat","%Carbs","HR", "Rel.VO2")]
```
...
Now plot the crossover with a label.  The package `ggplot2` [@R-ggplot2] is used to produce the plots.
```{r fig-12346vo2, fig.cap = "%KCal / min ~ Heartrate"}
